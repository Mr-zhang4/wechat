...
/* Generated from ../O.Common/usb320AsynPortDriver.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_tsInitialize, pvar_func_usb320AsynPortDriverRegister;
...
int usb320AsynPortDriver_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics/support/asyn";
    ...
    pvar_func_usb320AsynPortDriverRegister();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* usb320AsynPortDriver_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"usb320AsynPortDriver_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(usb320AsynPortDriver_registerRecordDeviceDriver(*iocshPpdbbase));
}
