...
//https://open.weixin.qq.com/connect/oauth2/authorize?appid=企业号ID&redirect_uri=http://服务器域名/query.php&response_type=code&scope=snsapi_privateinfo&agentid=1000002&state=1#wechat_redirect
	$code = $_GET["code"];  
...
//			$user_obj = json_decode($res['content'],true);
		...
		$url="./alminfosubs/infoEnquiry.php";
		header("Location: {$url}"); 
